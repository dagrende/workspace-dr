# com-chilipeppr-workspace-dr
A ChiliPeppr Workspace dr.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / dr
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-dr |
| Name                  | Workspace / dr |
| Description           | A ChiliPeppr Workspace dr. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/dagrende/workspace-dr/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/dagrende/workspace-dr |
| Github URL            | http://github.com/dagrende/workspace-dr |
| Test URL              | https://preview.c9users.io/dagrende/workspace-dr/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/dagrende/workspace-dr/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-dr"], // the id you gave your workspace
      function(myWorkspaceDr) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / dr just got loaded.", myWorkspaceDr);
        myWorkspaceDr.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-dr"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / dr"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace dr."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/dagrende/workspace-dr/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/dagrende/workspace-dr"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/dagrende/workspace-dr"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-dr-dagrende.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
